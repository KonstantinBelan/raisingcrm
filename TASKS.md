...
- [ ] Добавить редактирование проекта
- [ ] Реализовать статусы проектов
- [ ] Добавить фильтрацию и поиск
- [ ] Создать страницу детального просмотра проекта

### 2.3 Модуль "Задачи"
- [ ] Создать компонент списка задач
- [ ] Реализовать создание задач
- [ ] Добавить редактирование задач
- [ ] Реализовать иерархию задач (подзадачи)
- [ ] Добавить трекинг времени
- [ ] Создать календарь дедлайнов
- [ ] Реализовать drag-and-drop для изменения статусов

### 2.4 Модуль "Клиенты"
- [ ] Создать базу клиентов
- [ ] Реализовать создание и редактирование клиентов
- [ ] Добавить привязку проектов к клиентам
- [ ] Создать историю взаимодействий
- [ ] Добавить заметки по клиентам
